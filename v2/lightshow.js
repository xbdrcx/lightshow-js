...
function activateButtons() {
    beamOptionsButton.removeAttribute("disabled")
    laserOptionsButton.removeAttribute("disabled")
...
function disabledButtons() {
    beamOptionsButton.setAttribute("disabled", true)
    laserOptionsButton.setAttribute("disabled", true)
