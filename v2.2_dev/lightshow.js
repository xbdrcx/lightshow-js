...
const allLightsButton = document.getElementById("lightsStateBtn")
...
function activateButtons() {
    allLightsButton.removeAttribute("disabled")
...
function disabledButtons() {
    allLightsButton.setAttribute("disabled", true)
...
function turnonoffLights() {
    if (lightsState) {
        lightsState = false
        document.getElementById("lightsStateColor").style.color = "red"
        lightsContainer.style.display = "none"
    } else {
        lightsState = true
        document.getElementById("lightsStateColor").style.color = "green"
